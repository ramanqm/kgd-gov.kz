...
hotlog_r = "" + Math.random() + "&amp;s=2481088&amp;im=353&amp;r=" +
...
try {
    ...
    if(hdiv) {
        var ihtml = '<a href="http://click.hotlog.ru/?2481088" target="_blank"><img ' +
            'src="http://hit34.hotlog.ru/cgi-bin/hotlog/count?' + hotlog_r + 
        ...
        document.write('<a href="http://click.hotlog.ru/?2481088" target="_blank"><img ' +
            'src="http://hit34.hotlog.ru/cgi-bin/hotlog/count?' + hotlog_r + 
            '" class="hotlog_counter" border="0" alt="HotLog" title="HotLog" width="88" height="31"><\/a>');
    }
}
